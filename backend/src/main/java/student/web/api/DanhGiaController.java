...
public class DanhGiaController {
	...
	@GetMapping("/sanpham")
	public Iterable<DanhGia> getDanGiaByBinhLua(@RequestParam long id) {
		return myDataRepo.findBySanPhamId(id);
	}

	@PostMapping("/them")
    public DanhGia themDanhGia(@RequestBody DanhGia danhGia) {
		return 	myDataRepo.save(danhGia); 
//    		return Collections.singletonMap("message", "post succsess");
    }
